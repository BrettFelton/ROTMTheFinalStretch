...
{
    [Authorize]
    public class ProjectedBookingsController : Controller
    {
        ...
        public ActionResult ProjectedBookingsReport()
        {
            ...
            rd.Load(Path.Combine(Server.MapPath("~/Reporting"), "ProjectedBookingsReport.rpt"));
            ...
            return File(stream, "application/pdf", "ProjectedBookingsReport.pdf");
        }
